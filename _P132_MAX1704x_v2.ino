/*
 * Plugin 132 MAX1704x I2C, Sparkfun Fuel Gauge Sensor
 * 
 * development version
 * by: jbaream
...
#define PLUGIN_132                          
#define PLUGIN_ID_132     132               //plugin id
#define PLUGIN_NAME_132   "Energy - Fuel Gauge MAX1704x [DEVEL]"     
#define PLUGIN_VALUENAME1_132 "Voltage"     // Battery voltage
#define PLUGIN_VALUENAME2_132 "SOC"     // Battery state of charge in percentage
#define PLUGIN_VALUENAME3_132 "Alert"   // (0 or 1) Alert when the battery SoC gets too low 
...
boolean Plugin_132(byte function, struct EventStruct *event, String& string)
{
  ...
  switch (function)
  {
    ...
    case PLUGIN_WEBFORM_LOAD:
    {
      ...
      addFormNumericBox(F("Alert threhold"), F("p132_max1704x_threhold"), PCONFIG(0),1,30);
      addUnit(F("%")); 
    ...
    case PLUGIN_WEBFORM_SAVE:
    {
      ...
      PCONFIG(0) = getFormItemInt(F("p132_max1704x_threhold"));
      success = true;
      break;
